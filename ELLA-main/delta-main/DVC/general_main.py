...
if __name__ == "__main__":
    ...
    parser.add_argument('--nc_first_task', dest='nc_first_task', default=10, type=int, help='Choice of different number of classes in the first phase')
    ...
    parser.add_argument('--lfh', dest='lfh', default=False, help='Set learn from half as true for half the number of classes in task 1. Default is Learn From Scratch (LFS)')
