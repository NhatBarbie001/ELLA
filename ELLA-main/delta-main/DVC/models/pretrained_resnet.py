...
class ResNet(nn.Module):
    ...
    def features(self, x):
        ...
        # print('out: ', out.shape)
        out = self.layer1(out)
        #print('out l1: ', out.shape)
        out = self.layer2(out)
        #print('out l2: ', out.shape)
        out = self.layer3(out)
        #print('out l3: ', out.shape)
        out = self.layer4(out)
        #print('out l4: ', out.shape)
        out = avg_pool2d(out, 4)

        #Vfn
        out = avg_pool2d(out, 7)

        #print('out pool: ', out.shape)
...
class DVCNet(BaseModule):
    ...
    def forward(self, x, xt):
        ...
        #print('zz and fea: ', zz.shape, fea.shape)
        z = zz[0:size]
        zt = zz[size:]
...
def Reduced_ResNet18_DVC_pre(nclasses, nf=20, bias=True):
    """
...
def Reduced_ResNet18_pre(nclasses, nf=20, bias=True):
    """
    Reduced ResNet18 as in GEM MIR(note that nf=20).
    """
