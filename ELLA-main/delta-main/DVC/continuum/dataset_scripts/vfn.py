...
class VFN(DatasetBase):
	...
	def setup(self):
		if self.scenario == 'ni':
			...
			self.task_labels, self.data = create_task_composition_vfn(class_nums=74, num_tasks=self.task_nums, nc_first_task=14, class_order = class_order_table[class_order_var], \
