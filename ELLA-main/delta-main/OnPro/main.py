...
def get_params():
    ...
    parser.add_argument('--buffer_batch_size', type=int, default=16, help='(default=%(default)s)')
    ...
    ######Extra argumets for customization#######
    parser.add_argument('--num_tasks', dest='num_tasks', type=int, default=10)
    parser.add_argument('--nc_first_task', dest='nc_first_task', type=int, default=10)
